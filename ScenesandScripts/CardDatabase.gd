...
const CARDS2 = { #Student Deck
	...
	"University Center Complex": [0, 2, 1, "Guardian", null, null],
	"Grading Curve": [1, 0, 1, "Spell", null, null],
	"Extra Credit": [0, 0, 2, "Spell", null, null],
	"Prepared to Learn": [0, 2, 2, "Spell", null, null],
	"Failed Test": [4, 0, 3, "Spell", null, null],
	"Honor Code Validation": [3, 0, 4, "Spell", null, null],
...
const CARDS4 = { #Mixed Deck
	...
	"Sleep Deprived": [1, 0, 2, "Spell", null, null],
	"Tough Classes": [0, 0, 2, "Spell", null, null],
...
const CARDS5 = { #History Deck
	...
	"National Center for Secure and Resilient": [3, 0, 3, "Spell", null, null],
	"Office of Innovation and Entrepreneruship": [1, 0, 1, "Spell", null, null],
