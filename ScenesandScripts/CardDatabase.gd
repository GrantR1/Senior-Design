...
const CARDS5 = { #History Deck
	...
	"The Center for Maritime Systems at Stevens": [0, 5, 6, "Description \n Guardian", "Initially founded to study ships, but has since expanded to things such as storm forecasting.", null,"The Center for Maritime Systems at Stevens"],
