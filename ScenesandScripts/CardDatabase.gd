...
const CARDS2 = { #Student Deck
	"Undergrad": [2, 1, 1, "Spell", "A simple student trying for their bachelor's degree. Wish them luck!", null,"Undergrad"],
	...
	"Atilla the Duck": [4, 1, 4, "Spell", "A fierce duck with a love for free bread and swimming in the Hudson. Doesn't play well with hawks.", null,"Atilla the Duck"],
	...
	"University Center Complex": [0, 3, 1, "Guardian", "Housing thousands of students since 2022!", null,"University Center Complex"],
	"Grading Curve": [2, 2, 1, "Spell", " Fear the professor who uses it and beg the others to get it.", null,"Grading Curve"],
...
const CARDS3 = { #Statistics Deck
	...
	"Moody Student": [1,2,2, "Spell", "In ten years, you’ll think back, remember them, and wish you hadn’t.", null,"Moody Student"],
	...
	"Study Session": [2, 2, 2, "Spell", "Can you say that all again... like from the beginning?", null,"Study Session"],
	"Tough Classes": [3, 2, 2, "Spell", "'Is there a curve?' Only a normal one in MA-331.", null,"Tough Classes"],
	...
	"MA-623 Stochastic Processes": [2, 4, 1, "Spell", "Markov chains are easy! Just don't get stuck in an absorbing state.", null,"MA-623 Stochastic Processes"]
}
...
const CARDS4 = { #Mixed Deck
	...
	"SS Stevens victory": [1, 5,3, "Guardian", "The words Stevens and Victory belong together.", null,"SS Stevens victory"],
	"Walker Gymnasium": [0, 3, 2, "Guardian", "Hit the gym and strengthen your battlefield", null,"Walker Gymnasium"],
...
const CARDS5 = { #History Deck
	...
	"William H. Perice": [1, 3, 3, "Spell", "A civil engineer and metallurgist. His prowess in the latter earned him the title 'Copper King' (see the crown?).", null,"William H. Perice"],
	"Henry Morton": [6, 1, 5, "Spell", "The first president of Stevens Institute of Technology with a penchant for poetry.", null,"Henry Morton"],
	...
	"Stevens' S.C. Williams Library": [0, 3, 4, "Guardian", "Librarians are always willing to help on the first floor, but no talking on the third floor!", null,"Stevens' S.C. Williams Library"],
	...
	"The Center for Innovation in Engineering and Science Education": [2, 0, 2, "Spell", "Stevens' dedication to education goes beyond its own classrooms!", null,"The Center for Innovation in Engineering and Science Education"],
	"The Center for Environmental Systems": [2, 3, 1, "Spell", "Now more than ever, sustainability is an important concern.", null,"The Center for Environmental Systems"], 
	"The Highly Filled Materials Institute": [1, 2, 2, "Spell", "Is this at all applicable to jelly donuts? ... Oh, I was WAY off.", null,"The Highly Filled Materials Institute"]
}
